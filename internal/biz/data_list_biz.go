...
type DataListRepository interface {
	...
	GetByID(ctx context.Context, id int64) (*sqlc.DataList, error)
	...
	GetAllByKinds(ctx context.Context, kinds *params.GetAllDataListByKindsParams) ([]*sqlc.DataList, error)
...
func (h *DataListBiz) Get(ctx context.Context, id int64) (*sqlc.DataList, error) {
	return h.dlr.GetByID(ctx, id)
}

func (h *DataListBiz) Create(ctx context.Context, p *params.CreateDataListParams) (*sqlc.DataList, error) {
...
func (h *DataListBiz) Update(ctx context.Context, p *params.UpdateDataListParams) (*sqlc.DataList, error) {
	return h.dlr.Update(ctx, p)
}

func (h *DataListBiz) GetAll(ctx context.Context) ([]*sqlc.DataList, error) {
	return h.dlr.GetAll(ctx)
}

func (h *DataListBiz) ListByKind(ctx context.Context, p *params.ListDataByKindParams) ([]*sqlc.DataList, int, error) {
	if err := p.Optimize(); err != nil {
		return nil, 0, err
	}
...
func (h *DataListBiz) GetAllByKinds(ctx context.Context, p *params.GetAllDataListByKindsParams) ([]*sqlc.DataList, error) {
	return h.dlr.GetAllByKinds(ctx, p)
}

func (h *DataListBiz) GetSortData(ctx context.Context, p *params.GetDataListSortDataParams) ([]*sqlc.DataList, error) {
