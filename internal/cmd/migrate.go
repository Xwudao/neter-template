...
func newMigrateCmd(upCmd *upCmd, downCmd *downCmd) *migrateCmd {
	m := &cobra.Command{
		Use:   "migrate",
		Short: "migrate database",
	}

	m.AddCommand(upCmd.getCmd(), downCmd.getCmd())

	rtn := &migrateCmd{
		cmd: m,
	}
	m.Flags().StringP("name", "n", "", "the migration name for this migrate.")

	return rtn
}

func (i *migrateCmd) getCmd() *cobra.Command {
	return i.cmd
}

func (i *migrateCmd) run(cmd *cobra.Command, args []string) {
	fmt.Println("migrateCmd called")
}
...
func (i *upCmd) getCmd() *cobra.Command {
	return i.cmd
}

func (i *upCmd) run(cmd *cobra.Command, args []string) {
	fmt.Println("upCmd called")
}
...
func (i *downCmd) getCmd() *cobra.Command {
	return i.cmd
}

func (i *downCmd) run(cmd *cobra.Command, args []string) {
	fmt.Println("upCmd called")
}
