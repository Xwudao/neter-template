...
func (tx *Tx) init() {
	tx.DataList = NewDataListClient(tx.config)
	tx.SiteConfig = NewSiteConfigClient(tx.config)
...
// applies a query, for example: DataList.QueryXXX(), the query will be executed
